...
public class ServiceNames {
    ...
    public static final String APP_STATUS_BY_ID = API + "/app_status_by_id?";
    ...
    public static final String ARCHIVE_TRIP = API + "/archive_trip?";
...
//    public static final String CAR_LIST = "http://demo8142432.mockable.io/carlist?";
    ...
    public static final String CANCELLED_TRIP_LIST = API + "/cancelled_trip_list?";
    public static final String COMPLETED_TRIP_LIST = API + "/completed_trip_list?";
    public static final String ARCHIVED_TRIP_LIST = API + "/archived_trip_list?";
