...
public final class LocationUtility {
	...
	public static void showLocationSettingsPrompt(final View view) {
		...
		Snackbar
				.make(view, context.getString(R.string.message_home_location_added), LOCATION_SETTINGS_PROMPT_DURATION)
				.setAction(context.getString(R.string.message_please_enable_location_service_from_settings), new View.OnClickListener() {
					@Override
