package eg.mimocodes.sciencehub.advancedwebview;
...
import eg.mimocodes.sciencehub.activity.LoginActivity;
import eg.mimocodes.sciencehub.activity.ScienceHubActivity;
import eg.mimocodes.sciencehub.utility.ImageCaptureHelper;
import eg.mimocodes.sciencehub.utility.LocationUtility;
...
public class AdvancedWebView extends WebView {
	...
	private ProgressDialog progressBar = new ProgressDialog(this.getContext(),R.style.full_screen_dialog){
		@Override
		...
		super.setWebViewClient(new WebViewClient() {
			...
			public void onPageStarted(WebView view, String url, Bitmap favicon) {
				...
				if (mCustomWebViewClient != null) {
					...
					if(LoginActivity.getDefaults("AppLoggingOut",getContext()).equals("0")) {
						try{
			...
			public void onPageFinished(WebView view, String url) {
				...
				if (mCustomWebViewClient != null) {
					...
					{
						String user_name = LoginActivity.getDefaults("UserName", getContext());
						String user_pass = LoginActivity.getDefaults("UserPass", getContext());
						LoginActivity.setDefaults("IsLoggedIn","1", getContext());
					...
					if(LoginActivity.getDefaults("AppLoggingOut",getContext()).equals("0") && progressBar.isShowing()) {
						try{
							progressBar.dismiss();
						}
						catch (Exception e)
					...
					{
						LoginActivity.setDefaults("AppLoggingOut", "0", getContext());
					}
